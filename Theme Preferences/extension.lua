...
dialog:separator{text = "文本"}

ThemeColor("常规", "text_regular", true)
ThemeColor("活动", "text_active", true)
ThemeColor("链接/分隔符", "text_link", false)
...
dialog:separator{text = "输入栏"}

ThemeColor("高亮", "field_highlight", true)
...
ThemeColor("图标", "editor_icons", true)
...
ThemeColor("鼠标选中时", "button_selected", true)

dialog:separator{text = "标签页"}
...
ThemeColor("鼠标悬停时", "window_hover", true)
...
:button{text = "应用", onclick = function() Refresh() end} -- 
:button{
    text = "取消",
    onclick = function()
        LoadCurrentTheme()
