...
error_messages = {
    invalid_api_version = "此脚本需要 Aseprite v1.2.30 或更新版本。请更新 Aseprite 以继续。",
    no_active_sprite = "没有可用的活动精灵。",
    save_required = "必须先保存精灵，然后才能运行此脚本。",
    snapshot_required = "您需要至少拍摄一张快照才能加载延时摄影.",
}
